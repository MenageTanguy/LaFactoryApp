...
export const SalleDeleteDialog = (props: ISalleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="laFactoryApp.salle.delete.question">Are you sure you want to delete this Salle?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-salle" color="danger" onClick={confirmDelete}>
