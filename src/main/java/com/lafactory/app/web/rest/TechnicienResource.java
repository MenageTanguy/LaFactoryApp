...
/**
 * REST controller for managing {@link com.lafactory.app.domain.Technicien}.
 */
@RestController
@RequestMapping("/api")
public class TechnicienResource {
    ...
    public ResponseEntity<Technicien> updateTechnicien(@RequestBody Technicien technicien) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, technicien.getId().toString()))
            .body(result);
    }
